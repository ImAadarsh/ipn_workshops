...
$upcomingWorkshops = [];
$sql = "SELECT * FROM workshops WHERE start_date > NOW() AND status = 1 AND is_deleted = 0 ORDER BY start_date ASC LIMIT 6";
...
$completedWorkshops = [];
$sql = "SELECT * FROM workshops WHERE start_date < NOW() AND status = 1 AND is_deleted = 0 ORDER BY start_date DESC LIMIT 6";
$result = mysqli_query($conn, $sql);
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-12">
                            ...
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="<?php echo $isFirst ? 'col-12 mb-4' : 'col-xl-4 col-md-6'; ?>">
                                            ...
                                            <div class="card-body <?php echo $isFirst ? 'bg-success bg-opacity-10' : ''; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <img src="<?php echo $uri.$workshop['image']; ?>" class="mb-3" style="border-radius: 20px; border: solid 8px green;" width="480" height="250" alt="Trainer">
                                                        <?php endif; ?>
                                            </div>
                                                    <div class="col-md-8">
                                        ...
                                        <div class="card <?php echo $isFirst ? 'border-primary' : ''; ?>">
                                            <div class="card-body <?php echo $isFirst ? 'bg-primary bg-opacity-10' : ''; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <?php if ($workshop['image']): ?>
                                                        <img src="<?php echo $uri.$workshop['image']; ?>" class="mb-3" style="border-radius: 20px; border: solid 8px rgb(253, 13, 13);" width="480" height="250" alt="Trainer">
                                                        <?php endif; ?>
                                                                </div>
                                                    <div class="col-md-8">
                                                        <div class="d-flex justify-content-between align-items-start">
