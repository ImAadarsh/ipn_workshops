...
// Fetch stats for TLC Edition 3 users
$stats_sql = "SELECT 
    COUNT(*) as total_users, 
    COUNT(DISTINCT city) as unique_cities, 
    COUNT(DISTINCT institute_name) as unique_institutes,
    SUM(is_tlc_new_edition_3 = 1) as new_users,
    SUM(tlc_email_sent_edition_3 = 1) as mail_stats,
    SUM(is_tlc_new_edition_3 = 0) as existing_users
    FROM users WHERE tlc_edition_3 = 1";
$stats_result = mysqli_query($conn, $stats_sql);
$stats = mysqli_fetch_assoc($stats_result);

// Fetch all users marked for TLC Edition 3
$users_sql = "SELECT id, name, email, mobile, country_code, city, institute_name, is_tlc_new_edition_3, tlc_join_date_edition_3 FROM users WHERE tlc_edition_3 = 1 ORDER BY tlc_join_date_edition_3 DESC";
...
<head>
    <meta charset="utf-8" />
    <title>TLC Edition 3 Users | IPN Academy</title>
                        ...
                        <div class="page-title-box">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">TLC Edition 3 Users</li>
                                </ol>
                            </div>
                            <?php endif; ?>
                            <h4 class="page-title">TLC Edition 3 Users</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4 class="header-title mb-0">TLC Edition 3 User List</h4>
                                <div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td<?php if ($user['tlc_join_date_edition_3']) { echo ' data-order=\"' . strtotime($user['tlc_join_date_edition_3']) . '\"'; } ?>><?php
                                                    if ($user['tlc_join_date_edition_3']) {
                                                        $dt = new DateTime($user['tlc_join_date_edition_3'], new DateTimeZone('UTC'));
                                                ...
                                                ?></td>
                                                <td><?php echo $user['is_tlc_new_edition_3'] == 1 ? '<span class="badge bg-danger">New</span>' : '<span class="badge bg-secondary">Existing</span>'; ?></td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
